...
/**
 * Takes a coordinate in a WGS-84 reference system and provides the tile address (x,y) and pixel location on the tile
 * (px,py) at the given zoom in Mercator projection.
 */
@Description(
  name = "tileUDF",
...
public class TileUDF extends GenericUDF {
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
    ...
    return ObjectInspectorFactory
      .getStandardStructObjectInspector(Arrays.asList("x", "y", "px", "py"),
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    try {
      ...
      return Arrays.<Object>asList(
        ...
        mercator.longitudeToTileLocalPixelX(longitude, (byte) zoom.get()),
        mercator.latitudeToTileLocalPixelY(latitude, (byte) zoom.get()));
