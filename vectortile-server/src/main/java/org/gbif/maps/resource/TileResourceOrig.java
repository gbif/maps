...
@Path("/old")
@Singleton
public final class TileResourceOrig {

  private static final Logger LOG = LoggerFactory.getLogger(TileResourceOrig.class);
  ...
  public TileResourceOrig() throws IOException {
