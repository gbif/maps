...
object App {
  ...
  def main(args: Array[String]) {
    ...
    val partitioner = new HashPartitioner[String, Byte]();
    ...
    val tiles = df.flatMap(row => {
      ...
      */
      ...
      (4 to 6).flatMap(z => {
        ...
        List(
          ((MAPS_TYPES("TAXON"), kingdomKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), phylumKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), classKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), orderKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), familyKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), genusKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("TAXON"), speciesKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("DATASET"), datasetKey, z, x, y, px, py, year),1),
          ((MAPS_TYPES("PUBLISHER"), publisherKey, z, x, y, px, py, year),1)
        );
      })
    ...
    tiles
      .saveAsNewAPIHadoopFile("hdfs://c1n1.gbif.org:8020/tmp/tim_v23", classOf[ImmutableBytesWritable],
